...
def match(array_of_words)
  ...
  #4. Remember that you can split a word into an array of letters using some_word.split("").
    # You can compare two arrays using the ==
  #5. Two arrays are equal if they contain the same elements, in the same order.
